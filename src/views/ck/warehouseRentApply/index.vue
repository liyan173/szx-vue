        ...
        <el-card shadow="hover">
          <el-form ref="queryFormRef" :model="queryParams" :inline="true">
            <el-form-item label="申请标题" prop="title">
              <el-input v-model="queryParams.title" placeholder="请输入申请标题" clearable @keyup.enter="handleQuery" />
            </el-form-item>
            ...
            <el-form-item label="可租面积(㎡)" prop="rentableArea">
              <el-input v-model="queryParams.rentableArea" placeholder="请输入可租面积(㎡)" clearable @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item label="起租面积(㎡)" prop="minRentArea">
              <el-input v-model="queryParams.minRentArea" placeholder="请输入起租面积(㎡)" clearable @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item label="价格(元/㎡·月)" prop="price">
              <el-input v-model="queryParams.price" placeholder="请输入价格(元/㎡·月)" clearable @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item label="物业单价(元/㎡·月)" prop="propertyPrice">
              <el-input v-model="queryParams.propertyPrice" placeholder="请输入物业单价(元/㎡·月)" clearable @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item label="自动下架日期" prop="autoOffDate">
              <el-date-picker clearable
                v-model="queryParams.autoOffDate"
                type="date"
            ...
            <el-form-item label="信息描述" prop="infoDesc">
              <el-input v-model="queryParams.infoDesc" placeholder="请输入信息描述" clearable @keyup.enter="handleQuery" />
            </el-form-item>
            <el-form-item>
